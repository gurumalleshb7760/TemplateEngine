...
class Equal(Expression):
    """This object allows to compare if an object is Equal to an other."""
    ...
    def value(self):
        """Returns the result of the different operation : 1 if they're equal and 0 if they're different."""
